...
public enum Phrases {
    ...
    public static void installPhrases() {
        Phrases ph;
        for(Iterator var1 = Arrays.asList(values()).iterator(); var1.hasNext(); ph.PhraseStr = Lang.getString(ph.toString())) {
    ...
    public static List<String> valuesAsString() {
        ...
        Iterator var2 = Arrays.asList(values()).iterator();
    ...
    public static enum Vars {
        ...
        public List<String> getVars() {
            List<String> varsL = new ArrayList(Arrays.asList(this.varsset));
            return varsL;
        }
    }
}
